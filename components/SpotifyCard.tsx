const SpotifyCard = ({ album, albumImageUrl, artist, songUrl, title }) => {
  return (
    <a
      href={songUrl}
      className="card-link hover:bg-white dark:hover:bg-specialBlue"
      target="_blank"
    ...
    >
      <div className="inline-flex items-start shadow border border-gray-200 rounded-lg w-72 mt-2 p-2 bg-white hover:bg-green-50 transition-colors duration-500 ease-in-out">
        ...
        <div className="flex flex-col justify-center items-start ml-3">
          <p className="text-sm m-0 text-specialBlue mt-1 text-left dark:text-specialBlue">
            {artist}
          </p>
          <p className="text-sm font-medium text-specialBlue max-w-48 truncate w-48 m-0 text-left dark:text-specialBlue">
            {title}
          </p>
        </div>
        <svg className="h-5 w-5 ml-auto mt-1 mr-2" viewBox="0 0 168 168">
          <path
            fill="#1ED760"
